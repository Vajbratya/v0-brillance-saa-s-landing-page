...
const EffortlessIntegration: React.FC<EffortlessIntegrationProps> = ({ width = 482, height = 300, className = "" }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Central hub */}
        <div className="border-accent opacity-40"
          style={{
            width: "72px",
            height: "72px",
            left: `${centerX - 36}px`,
        ...
        >
          <img
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/framer-kUhcnsAeBTZOz7deVtfOzZTQpWq6IM.svg"
            alt="Framer"
            style={{
              width: "16px",
              height: "16px",
