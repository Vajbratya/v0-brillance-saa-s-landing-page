        ...
        <div className="relative bg-white rounded-lg shadow-lg border border-[#e0dedb] overflow-hidden">
          ...
          <div className="flex items-center justify-between p-4 border-b border-[#e0dedb]">
            <div className="flex items-center gap-3">
              <div className="text-[#37322f] font-semibold">laudos.ai</div>
              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
              <span className="text-sm text-[#605a57]">Conta</span>
            </div>
          ...
          <div className="flex">
            ...
            <div className="w-48 bg-[#fbfaf9] border-r border-[#e0dedb] p-4">
              <nav className="space-y-2">
                <div className="text-xs font-medium text-[#605a57] uppercase tracking-wide mb-3">Navegação</div>
                {["Início", "Clientes", "Laudos", "Relatórios", "API", "Configurações"].map((item) => (
            ...
            <div className="flex-1 p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-[#37322f]">Laudos Gerados</h2>
                <Button className="bg-[#37322f] hover:bg-[#37322f]/90 text-white text-sm">Gerar laudo</Button>
              </div>
                ...
                {Array.from({ length: 8 }).map((_, i) => (
                  <div key={i} className="grid grid-cols-6 gap-4 p-4 border-b border-[#e0dedb] text-sm">
                    ...
                    <div>
                      ...
                      >
                        {i % 3 === 0 ? "Concluído" : i % 3 === 1 ? "Processando" : "Pendente"}
                      </span>
                    </div>
                    <div className="text-[#605a57]">Laudo técnico</div>
                    <div className="font-medium">R$ 3.862,32</div>
                    <div className="text-[#605a57]">1 Ago 2024</div>
